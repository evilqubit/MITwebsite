...
if ($application->data)
{
	...
	$fields	= array(_text("ID"),_text("Company Name"),_text("Industry"),_text("Company City"),_text("Status"), _text(" Average Grade"),_text("Actions"));
	$width = array('10px;','','' , ''); 
	...
	{   
		...
		$mysheet->addSheetCell( $app["companyName"]); 
		$mysheet->addSheetCell( $app["companyName"]); 
		$mysheet->addSheetCell( $app["companyName"]);  
