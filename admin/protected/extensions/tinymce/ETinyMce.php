...
class ETinyMce extends CInputWidget{
    ...
    protected function makeCustomEditor($url=''){
        ...
        $this->plugins = array('safari', 'pagebreak', 'save', 'advimage', 'advlink', 'emotions', 'inlinepopups', 'preview', 'media', 'contextmenu', 'paste', 'directionality', 'noneditable', 'xhtmlxtras');
        ...
        $options['theme'] = 'advanced';
        $options['theme_advanced_buttons1'] = "newdocument,|,copy,paste,pasteword,|,undo,redo,|,removeformat,|,ltr,rtl,|,code,preview,|,formatselect,fontsizeselect";
        $options['theme_advanced_buttons2'] = "forecolor,backcolor,|,bold,italic,underline,strikethrough,|,sub,sup,|,justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,hr,pagebreak,|,charmap,emotions,media,image,|,link,unlink";
